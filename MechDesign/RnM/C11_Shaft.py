...
#----------------------------------------------------------------------------------------------------        
    ...
    def E11_26A_AngleOfInclination(self):
        """  """
        alphaprime=0
        # 10.19*self.F_A/self.E, "*SUM(self.a_1**2/self.d_a1**4+(self.a_2**2-self.a_1**2)/self.d_a2**4+...+(self.a_n**2-self.a_n-1**2)/self.d_an**4)"  #SUM TO BE IMPLEMENTED //a_n, d_an not defined
        print('!!!!!! SUM TO BE IMPLEMENTED by user')
        return alphaprime
    ...
    def E11_26B_AngleOfInclination(self):
        """  """
        betaprime=0
        # 10.19*self.F_A/self.E, "*SUM(self.b_1**2/self.d_b1**4+(self.b_2**2-self.b_1**2)/self.d_b2**4+...+(self.b_n**2-self.b_n-1**2)/self.d_bn**4)"   #SUM TO BE IMPLEMENTED //b_n, d_bn not defined
        print('!!!!!! SUM TO BE IMPLEMENTED by user')
        return betaprime
